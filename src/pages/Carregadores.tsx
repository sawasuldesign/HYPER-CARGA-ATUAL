...
const Carregadores = () => {
  ...
  const carregadores = [
    ...
    {
      id: "wallbox-dc-22kw",
      name: "Estação Wallbox DC 22kWh 1 CCS2",
      image: "https://res.cloudinary.com/dt2qlgxcl/image/upload/v1756146566/wallbox_msbbpu.png",
      shortName: "Wallbox DC 22kW",
      description: "Estação de recarga DC inteligente de 22 kW com alta confiabilidade e interface touch colorida. Equipado com conector CCS2, protocolos ISO15118 e DIN SPEC 70121, oferece eficiência superior a 95%.",
      fullDescription: "Estação de recarga DC inteligente de 22 kW com alta confiabilidade e interface touch colorida. Equipado com conector CCS2, protocolos ISO15118 e DIN SPEC 70121, oferece eficiência superior a 95% e conectividade OCPP 1.6. Sistema de auto-diagnóstico e resfriamento ativo garantem operação segura em temperaturas de -35°C a 50°C. Ideal para estabelecimentos comerciais, condomínios e aplicações urbanas.",
      specs: {
        "Potência de saída": "22 kW",
        "Tensão de saída": "200V a 1000V",
        "Corrente máxima": "110A",
